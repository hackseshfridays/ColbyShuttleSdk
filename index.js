...
var BASE_URL = 'https://colbyshuttle.ridesystems.net/Services/JSONPRelay.svc';
// Endpoints
var SHUTTLE_LOCATIONS = '/GetMapVehiclePoints';
var MAP_STOP_ESTIMATES = '/GetMapStopEstimates';
/*
  getShuttleLocation returns the location of the shuttle with some other useful
  information such as speed and direction
*/
exports.getShuttleLocation = function () {
    return __awaiter(this, void 0, void 0, function () {
        var resp;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, axios_1.default.get(BASE_URL + SHUTTLE_LOCATIONS)];
                case 1:
                    resp = _a.sent();
...
/*
  ...
  skipping stops
*/
exports.getMapStopEstimates = function () {
    return __awaiter(this, void 0, void 0, function () {
        var resp;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, axios_1.default.get(BASE_URL + MAP_STOP_ESTIMATES)];
                case 1:
                    resp = _a.sent();
                    return [2 /*return*/, resp.data];
            }
